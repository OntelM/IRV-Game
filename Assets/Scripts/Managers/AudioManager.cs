...
public class AudioManager{
    ...
    public static List<AudioSource> backgroundMusic = new List<AudioSource>();
    ...
    public static void Init()
    {
        ...
        volumeMusic = PlayerPrefs.GetFloat("volumeMusic", 0.1f);
    ...
    public static void SetVolume(AudioChannel channel, float volume)
    {
        switch (channel)
        {
            ...
            case AudioChannel.Music:
                ...
                volumeMusic = volume;
                foreach (var source in backgroundMusic)
                {
    ...
    public static void PlayBackgroundMusic(AudioSource source, float delay = 0)
    {
        ...
        //foreach (var S in backgroundMusic)
        //{
        //    if (S == source);
        //    return;
        //}
    ...
    public static void StopBackgroundMusic(AudioSource source, float delay = 0)
    {
        //backgroundMusic = source;
    ...
    public static void StopAmbientalSound(AudioSource source, float delay = 0)
    {
        source.volume = volumeAmbient;
        source.Stop();
        ambientList.Remove(source);
